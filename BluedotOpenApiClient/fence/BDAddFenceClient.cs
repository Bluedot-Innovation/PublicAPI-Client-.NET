...
* Add fence c# client demonstrates adding fences of various shapes to an existing zone using net http web api library
* Circular fence
* Bounding Box
* Polygonal
*/
...
namespace BluedotPublicApiClient.zoneclient
{
    public class BDAddFenceClient
    {
        ...
        private static String bdRestUrl = "http://bdapplication4.cloudapp.net:3033/1/fences";
