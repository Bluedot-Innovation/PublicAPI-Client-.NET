 ...
 * Create Message Action client demonstrates adding an action with conditions to an existing the customer's zone using .net http web api library
 */
...
namespace BluedotPublicApiClient.actionclient
{
    public class CreateMessageActionWithConditions
    {
        ...
        private static String bdZoneId            = "aaeb1e68-72c2-4151-a461-da626baac0e7"; //This is the id of the zone being updated. This can be fetched by calling GET Zones API
