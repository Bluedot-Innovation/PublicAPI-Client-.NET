 ...
 * Create Message Action client demonstrates adding an action to an existing the customer's zone using .net http web api library
 */
...
namespace BluedotPublicApiClient.actionclient
{
    public class CreateMessageAction
    {
        ...
        private static String bdZoneId            = "71e66fca-aadc-48b2-bbd6-2bdc46572079"; //This is the id of the zone being updated. This can be fetched by calling GET Zones API
                            ...
                            "\"actions\": {" +
                                "\"messageActions\": [" +
                                    "{" +
                                        ...
                                        "\"message\": \"To protect the environment and reduce congestion, you have been charged $5. Thank you!\"" +
                                    "}" +
                                "]" +
                            "}" +
                        "}" +
