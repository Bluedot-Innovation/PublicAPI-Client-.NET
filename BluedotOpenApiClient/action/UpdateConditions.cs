...
namespace BluedotPublicApiClient.actionclient
{
    public class UpdateConditions
    {
        ...
        private static String bdCustomActionId                    = "6de96865-f3c8-42cf-bdc2-38027272770a"; //This is the id of the action being updated. This can be fetch by calling GET Zones API
        ...
        {
            String customActionWithCondtionsJson =
                 "{" +
                    "\"security\": {" +
                    ...
                    "}" +
                "}";
            return customActionWithCondtionsJson;
        }
