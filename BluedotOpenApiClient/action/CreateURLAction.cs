 ...
 * Create URL Action client demonstrates adding an URL action to an existing the customer's zone using .net http web api library
 */
...
namespace BluedotPublicApiClient.actionclient
{
    public class CreateURLAction
    {
        ...
        private static String bdZoneId            = "32cce128-16cb-46ca-ad34-eae84bce4c61"; //This is the id of the zone being updated. This can be fetched by calling GET Zones API
